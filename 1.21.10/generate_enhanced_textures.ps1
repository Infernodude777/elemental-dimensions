...
Write-Host "=== Creating Enhanced Block Textures ===`n"

# Enhanced Scorched Stone with lava cracks
Write-Host "Enhancing Scorched Stone texture..."
...
Write-Host "Enhancing Molten Glass texture..."
$bmp = New-Object System.Drawing.Bitmap(16, 16)
for ($y = 0; $y -lt 16; $y++) {
    for ($x = 0; $x -lt 16; $x++) {
...
Write-Host "Enhancing Coralite texture..."
$bmp = New-Object System.Drawing.Bitmap(16, 16)
for ($y = 0; $y -lt 16; $y++) {
    for ($x = 0; $x -lt 16; $x++) {
...
Write-Host "Enhancing Gaia Stone texture..."
$bmp = New-Object System.Drawing.Bitmap(16, 16)
for ($y = 0; $y -lt 16; $y++) {
    for ($x = 0; $x -lt 16; $x++) {
...
Write-Host "Enhancing Skyrock texture..."
$bmp = New-Object System.Drawing.Bitmap(16, 16)
for ($y = 0; $y -lt 16; $y++) {
    for ($x = 0; $x -lt 16; $x++) {
        # Cloud wisp pattern
...
Write-Host "Enhancing Celestial Stone texture..."
$bmp = New-Object System.Drawing.Bitmap(16, 16)
for ($y = 0; $y -lt 16; $y++) {
    for ($x = 0; $x -lt 16; $x++) {
        # Star pattern
...
Write-Host "`n=== Creating Particle Textures ===`n"

# Ember particle
Write-Host "Creating Ember particle..."
...
# Void particle
Write-Host "Creating Void particle..."
$bmp = New-Object System.Drawing.Bitmap(8, 8)
for ($y = 0; $y -lt 8; $y++) {
    for ($x = 0; $x -lt 8; $x++) {
        $centerX = 4; $centerY = 4
...
# Bubble particle
Write-Host "Creating Bubble particle..."
$bmp = New-Object System.Drawing.Bitmap(8, 8)
for ($y = 0; $y -lt 8; $y++) {
    for ($x = 0; $x -lt 8; $x++) {
        $centerX = 4; $centerY = 4
...
Write-Host "Creating Crystal Sparkle particle..."
$bmp = New-Object System.Drawing.Bitmap(8, 8)
...
Write-Host "`n=== All enhanced textures and particles created! ===`n"
