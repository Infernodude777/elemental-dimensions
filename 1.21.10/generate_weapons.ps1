...
Write-Host "=== Creating Legendary Weapon Textures ==="

# Infernal Edge (Fire Sword) - 16x16
Write-Host "Creating Infernal Edge (fire sword)..."
...
Write-Host "  Done: infernal_edge.png"

# Abyssal Spear (Water/Dark weapon) - 16x16
Write-Host "Creating Abyssal Spear (water spear)..."
...
Write-Host "  Done: abyssal_spear.png"

# Gaia Cleaver (Earth Axe) - 16x16
Write-Host "Creating Gaia Cleaver (earth axe)..."
...
$gaiaCleaver.Dispose()
Write-Host "  Done: gaia_cleaver.png"

# Starforged Blade (Celestial Sword) - 16x16
Write-Host "Creating Starforged Blade (celestial sword)..."
...
$starforged.Dispose()
Write-Host "  Done: starforged_blade.png"

# Tempest Bow (Wind/Sky bow) - 16x16
Write-Host "Creating Tempest Bow (wind bow)..."
...
$tempestBow.Dispose()
Write-Host "  Done: tempest_bow.png"

# Astral Pickaxe (Celestial pickaxe) - 16x16
Write-Host "Creating Astral Pickaxe (celestial pickaxe)..."
...
$astralPick.Dispose()
Write-Host "  Done: astral_pickaxe.png"

# Voidheart Bow (Void/Dark bow) - 16x16
Write-Host "Creating Voidheart Bow (void bow)..."
...
$voidBow.Dispose()
Write-Host "  Done: voidheart_bow.png"

Write-Host ""
Write-Host "=== All legendary weapon textures created! ==="
Write-Host "Created 7 weapon/tool textures"
