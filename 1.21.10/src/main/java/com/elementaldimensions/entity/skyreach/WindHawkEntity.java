...
import software.bernie.geckolib.util.GeckoLibUtil;public class WindHawkEntity extends HostileEntity implements GeoEntity {public WindHawkEntity(EntityType<?extends HostileEntity>t,World w){super(t,w);}
