...
import software.bernie.geckolib.util.GeckoLibUtil;public class CloudSentinelEntity extends HostileEntity implements GeoEntity {public CloudSentinelEntity(EntityType<?extends HostileEntity>t,World w){super(t,w);}
