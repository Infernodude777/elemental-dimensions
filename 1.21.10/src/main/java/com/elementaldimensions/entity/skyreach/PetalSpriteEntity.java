...
import software.bernie.geckolib.util.GeckoLibUtil;public class PetalSpriteEntity extends PassiveEntity implements GeoEntity {public PetalSpriteEntity(EntityType<?extends PassiveEntity>t,World w){super(t,w);}
