...
import software.bernie.geckolib.util.GeckoLibUtil;public class SkyWispEntity extends PassiveEntity implements GeoEntity {public SkyWispEntity(EntityType<?extends PassiveEntity>t,World w){super(t,w);}
