...
public class NecromanticSkeletonEntity extends HostileEntity implements GeoAnimatable {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public NecromanticSkeletonEntity(EntityType<? extends HostileEntity> entityType, World world) {
