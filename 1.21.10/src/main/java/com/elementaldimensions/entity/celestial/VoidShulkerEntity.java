...
import software.bernie.geckolib.util.GeckoLibUtil;public class VoidShulkerEntity extends HostileEntity implements GeoEntity {public VoidShulkerEntity(EntityType<?extends HostileEntity>t,World w){super(t,w);}
