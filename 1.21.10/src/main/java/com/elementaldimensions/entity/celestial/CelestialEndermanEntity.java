...
import software.bernie.geckolib.util.GeckoLibUtil;public class CelestialEndermanEntity extends HostileEntity implements GeoEntity {public CelestialEndermanEntity(EntityType<?extends HostileEntity>t,World w){super(t,w);}
