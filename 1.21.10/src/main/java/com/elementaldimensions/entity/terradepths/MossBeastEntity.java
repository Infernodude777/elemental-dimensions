...
import software.bernie.geckolib.util.GeckoLibUtil;public class MossBeastEntity extends HostileEntity implements GeoEntity {public MossBeastEntity(EntityType<?extends HostileEntity>t,World w){super(t,w);}
