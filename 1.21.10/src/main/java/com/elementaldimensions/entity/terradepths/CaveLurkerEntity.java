package com.elementaldimensions.entity.terradepths;
...
public class CaveLurkerEntity extends HostileEntity implements GeoAnimatable {
	public CaveLurkerEntity(EntityType<? extends HostileEntity> entityType, World world) {
