...
import software.bernie.geckolib.util.GeckoLibUtil;public class RootSpiderEntity extends HostileEntity implements GeoEntity {public RootSpiderEntity(EntityType<?extends HostileEntity>t,World w){super(t,w);}
