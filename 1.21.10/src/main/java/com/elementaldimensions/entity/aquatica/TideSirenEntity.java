...
import software.bernie.geckolib.util.GeckoLibUtil;public class TideSirenEntity extends HostileEntity implements GeoEntity {public TideSirenEntity(EntityType<?extends HostileEntity>t,World w){super(t,w);}
