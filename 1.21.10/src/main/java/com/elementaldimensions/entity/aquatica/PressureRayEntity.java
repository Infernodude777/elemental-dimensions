...
import software.bernie.geckolib.util.GeckoLibUtil;public class PressureRayEntity extends HostileEntity implements GeoEntity {public PressureRayEntity(EntityType<?extends HostileEntity>t,World w){super(t,w);}
