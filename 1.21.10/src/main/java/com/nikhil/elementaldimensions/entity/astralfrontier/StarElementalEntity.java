...
public class StarElementalEntity extends PassiveEntity {

    public StarElementalEntity(EntityType<? extends PassiveEntity> entityType, World world) {
        super(entityType, world);
        this.experiencePoints = 5;
    }

    public static DefaultAttributeContainer.Builder createStarElementalAttributes() {
