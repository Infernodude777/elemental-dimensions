...
public class PrimarchEntity extends HostileEntity {
    ...
    public static DefaultAttributeContainer.Builder createPrimarchAttributes() {
        return HostileEntity.createHostileAttributes()
                .add(EntityAttributes.GENERIC_MAX_HEALTH, 1000.0) // Double health of others
    ...
    private void fireWave() {
        ...
        for (LivingEntity entity : entities) {
            entity.damage(this.getDamageSources().inFire(), 12.0f);
    ...
    private void meteorShower() {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            for (LivingEntity entity : entities) {
                entity.damage(this.getDamageSources().hotFloor(), 14.0f);
            }
        }
    ...
    private void tidalWave() {
        ...
        for (LivingEntity entity : entities) {
            entity.damage(this.getDamageSources().mobAttack(this), 13.0f);
    ...
    private void iceSpikes() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            for (LivingEntity entity : entities) {
                entity.damage(this.getDamageSources().magic(), 14.0f);
    ...
    private void earthquake() {
        ...
        for (LivingEntity entity : entities) {
            entity.damage(this.getDamageSources().magic(), 10.0f);
    ...
    private void earthFissures() {
        ...
        for (int dir = 0; dir < 8; dir++) {
            ...
            for (int dist = 1; dist <= 10; dist++) {
                ...
                for (LivingEntity entity : entities) {
                    entity.damage(this.getDamageSources().lava(), 16.0f);
    ...
    private void elementalStorm() {
        ...
        for (LivingEntity entity : entities) {
            // Fire damage
            entity.damage(this.getDamageSources().inFire(), 15.0f);
