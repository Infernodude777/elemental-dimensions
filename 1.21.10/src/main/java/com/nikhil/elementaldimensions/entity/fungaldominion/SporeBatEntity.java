...
public class SporeBatEntity extends AmbientEntity {

    public SporeBatEntity(EntityType<? extends AmbientEntity> entityType, World world) {
        super(entityType, world);
        this.experiencePoints = 1;
    }

    public static DefaultAttributeContainer.Builder createSporeBatAttributes() {
