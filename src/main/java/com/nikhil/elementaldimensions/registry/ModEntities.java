...
public class ModEntities {
    ...
    private static final RegistryKey<EntityType<?>> PYROS_KEY = RegistryKey.of(RegistryKeys.ENTITY_TYPE, PYROS_ID);
    
    private static final Identifier LEVIATHAN_ID = Identifier.of(ElementalDimensions.MOD_ID, "leviathan");
    private static final RegistryKey<EntityType<?>> LEVIATHAN_KEY = RegistryKey.of(RegistryKeys.ENTITY_TYPE, LEVIATHAN_ID);
    
    private static final Identifier GOLIATH_ID = Identifier.of(ElementalDimensions.MOD_ID, "goliath");
    private static final RegistryKey<EntityType<?>> GOLIATH_KEY = RegistryKey.of(RegistryKeys.ENTITY_TYPE, GOLIATH_ID);
    
    private static final Identifier ZEPHYROS_ID = Identifier.of(ElementalDimensions.MOD_ID, "zephyros");
    private static final RegistryKey<EntityType<?>> ZEPHYROS_KEY = RegistryKey.of(RegistryKeys.ENTITY_TYPE, ZEPHYROS_ID);
    
    private static final Identifier PRIMARCH_ID = Identifier.of(ElementalDimensions.MOD_ID, "primarch");
    private static final RegistryKey<EntityType<?>> PRIMARCH_KEY = RegistryKey.of(RegistryKeys.ENTITY_TYPE, PRIMARCH_ID);
