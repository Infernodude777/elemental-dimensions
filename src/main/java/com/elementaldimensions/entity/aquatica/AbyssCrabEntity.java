...
import software.bernie.geckolib.util.GeckoLibUtil;public class AbyssCrabEntity extends HostileEntity implements GeoAnimatable {public AbyssCrabEntity(EntityType<?extends HostileEntity>t,World w){super(t,w);}
