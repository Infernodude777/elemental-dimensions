...
public class LumifinEntity extends AmbientEntity {

    public LumifinEntity(EntityType<? extends AmbientEntity> entityType, World world) {
        super(entityType, world);
        this.experiencePoints = 1;
    }

    public static DefaultAttributeContainer.Builder createLumifinAttributes() {
