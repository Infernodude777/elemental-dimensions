...
import com.elementaldimensions.item.weapon.*;
...
public class ModItems {
	...
	public static final Item FIRE_SWORD = registerItem("fire_sword",
			new FireSwordItem(new Item.Settings().fireproof().rarity(Rarity.RARE)));

	public static final Item WATER_SWORD = registerItem("water_sword",
			new WaterSwordItem(new Item.Settings().rarity(Rarity.RARE)));

	public static final Item EARTH_SWORD = registerItem("earth_sword",
			new EarthSwordItem(new Item.Settings().rarity(Rarity.RARE)));

	public static final Item AIR_SWORD = registerItem("air_sword",
			new AirSwordItem(new Item.Settings().rarity(Rarity.RARE)));
