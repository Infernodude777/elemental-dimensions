...
public class SoulStealerEntity extends HostileEntity implements GeoAnimatable {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public SoulStealerEntity(EntityType<? extends HostileEntity> entityType, World world) {
